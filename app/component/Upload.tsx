...
const [image, setImage] = useState<string | Blob>("");
  ...
  const handleFeedback = async (isCorrect: boolean) => {
    ...
    return(
        <>
          {/* Header */}
      <div className="w-full  text-center relative  text-3xl bg-transparent font-bold text-black my-5">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 flex justify-center">
          <Card className="p-6 bg-white w-1/2 shadow-2xl rounded-3xl transition-transform">
